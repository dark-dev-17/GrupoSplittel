...
namespace GPDataInformation
{
    public class Tools
    {
        public static void ValidDBobject(DBConnection Ecom_DBConnection_)
        {
            if (Ecom_DBConnection_ == null)
            {
                throw new GpExceptions("Sin referencia a base de datos");
            }
        }
        public static void ValidStringParameter(string Parameter, string ParameterName)
        {
            ...
            {
                throw new GpExceptions(string.Format("please enter the '{0}'", ParameterName));
            }
        }
