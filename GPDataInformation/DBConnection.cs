...
namespace GPDataInformation
{
    public class DBConnection
    {
        ...
        public void AddParameter(object value, string variable, string type)
        {
            ...
            {
                throw new GpExceptions(string.Format("{0} no es valido como parametro", type));
            }
        }
        public int ExecProcedure()
        {
            ...
            {
                throw new GpExceptions(string.Format("MySqlException - {0}", ex.Message));
            }
            catch (Exception ex)
            {
        ...
        private void CheckConnection()
        {
            if (Connection.State != System.Data.ConnectionState.Open)
            {
                throw new GpExceptions("Sin conexion a base de datos MySQL");
            }
        }
