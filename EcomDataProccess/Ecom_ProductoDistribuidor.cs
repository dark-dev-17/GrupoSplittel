...
{
    public class Ecom_ProductoDistribuidor
    {
        #region Propiedades
        [Display(Name = "Id")]
        ...
        ~Ecom_ProductoDistribuidor()
        {
            
        }
        public Ecom_ProductoDistribuidor()
        {

        }
        public Ecom_ProductoDistribuidor(Ecom_DBConnection Ecom_DBConnection_)
        {
        ...
        public bool Add()
        {
            try
            {
                Ecom_DBConnection_.StartProcedure("Admin_PrecioDistribuidor");
        ...
        {
            return Ecom_DBConnection_.ExecuteScalarInt("SELECT max(id) FROM t26_precios_distribuidores");
        }
        ...
        {
            List<Ecom_ProductoDistribuidor> List = null;
            MySqlDataReader Data = null;
            try
            {
                Ecom_Tools.ValidDBobject(Ecom_DBConnection_);
                Data = Ecom_DBConnection_.DoQuery(Statement);
                List = new List<Ecom_ProductoDistribuidor>();
                if (Data.HasRows)
                {
                    while (Data.Read())
                    {
                        List.Add(new Ecom_ProductoDistribuidor
                        {
